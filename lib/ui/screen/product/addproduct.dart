...
class addProduct extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<LoadProvider>(context,listen: false).changeboolValueisLoading(true);
  ...
  void clear(context){
    Provider.of<LoadProvider>(context,listen: false).changeboolValueisLoading(false);
