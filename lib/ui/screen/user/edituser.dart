                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      RowEdit(name: label_level, des: 'مطلوب'),
                      //mangwidget(),
                      ...
                      //admin
                      RowEdit(name: label_regoin, des: 'مطلوب'),
                      RegoinCombox(),
                      //manage
                      SizedBox(
                        height: 5,
                      ),
                      RowEdit(name: label_mobile, des: 'مطلوب'),
                      EditTextFormField(
                      ...
                      Center(
                        child: TextButton(
                            ...
                            onPressed: () {
                              ...
                              print(
                                  "level in update button" + level.toString());
                              print("regoin in update button" +
                                  regoin.toString());
                              if (level != null) {
