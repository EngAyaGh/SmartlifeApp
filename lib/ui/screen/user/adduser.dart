...
class _addUserState extends State<addUser> {
        ...
        child: Directionality(
            ...
            child: ContainerShadows(
              ...
              child: ModalProgressHUD(
                inAsyncCall:
                    Provider.of<LoadProvider>(context).isLoadingAddUser,
                child: Padding(
                        ...
                        child: TextButton(
                            ...
                            onPressed: () {
                              ...
                              if (level != null) {
                                ...
                                UserService().addUser(body).then((value) =>
                                    value != "error" ||
  ...
  void clear(body) {
    Provider.of<LoadProvider>(context, listen: false)
        .changeboolValueUser(false);
    controllerUsers.usersList.add(UserModel.fromJson(body));
